    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userDatabaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (userInfo != null) {
                        ...
                        edt_name.setText(userInfo.getPhone());
                        edt_phone.setText(userInfo.getAddress());
                        edt_address.setText(userInfo.getFullName());


                    }
                } else {

                    Toast.makeText(UserInfoActivity.this, "User info doesn't exist", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Toast.makeText(UserInfoActivity.this, "Failed to retrieve user info: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        tv_agree.setOnClickListener(v -> {
            ...
            userDatabaseReference.setValue(userInfo, (databaseError, databaseReference) -> {
                if (databaseError == null) {
                    ...
                    Toast.makeText(UserInfoActivity.this, "Failed to save user info: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        });
    }
